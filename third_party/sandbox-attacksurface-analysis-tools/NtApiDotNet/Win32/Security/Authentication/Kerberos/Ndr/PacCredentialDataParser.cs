...
namespace NtApiDotNet.Win32.Security.Authentication.Kerberos.Ndr
{
    ...
    {
        public _Unmarshal_HelperCredData(RpcClientResponse r) :
                base(r.NdrBuffer, r.Handles, r.DataRepresentation)
        {
        }
        public _Unmarshal_HelperCredData(byte[] ba) :
                base(ba)
        {
        }
    ...
    internal struct PAC_CREDENTIAL_DATA : INdrConformantStructure
    {
        ...
        private void Marshal(_Marshal_HelperCredData m)
        {
            ...
            m.Write_3(RpcUtils.CheckNull(Credentials, "Credentials"), CredentialCount);
        }
    ...
    internal static class PacCredentialDataParser
    {
        ...
        {
            _Marshal_HelperCredData m = new _Marshal_HelperCredData();
        ...
        {
            _Unmarshal_HelperCredData u = new _Unmarshal_HelperCredData(pickled_type);
